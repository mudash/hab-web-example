...
# Install chef
curl -L https://www.chef.io/chef/install.sh | bash || error_exit 'could not install chef'
...
echo -e "$CHEF_SERVER_IP $CHEF_SERVER_FQDN" | sudo tee -a /etc/hosts
